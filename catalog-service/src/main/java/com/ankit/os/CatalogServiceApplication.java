...
import com.ankit.os.entity.Order;
import com.ankit.os.repository.OrderRepository;
...
public class CatalogServiceApplication {
  ...
  public void initOrdersTable() {
    orderRepository.saveAll(Stream.of(new Order("mobile", "electronics", "white", 20000),
        new Order("T-Shirt", "clothes", "black", 999), new Order("Jeans", "clothes", "blue", 1999),
